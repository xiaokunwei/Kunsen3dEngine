...
namespace MatrixDecomposition
{
    ...
    typedef struct
    {
        KunSen::Vec4d t;     // Translation Component;
    ...
    void decompAffine(_HMatrix A, _affineParts * parts)
        {
			...
			parts->t = KunSen::Vec4d(A[X][W], A[Y][W], A[Z][W], 0);
...
void KunSen::Matrixf::decompose(KunSen::Vec3f& t,
	KunSen::Quat& r,
	KunSen::Vec3f& s,
	KunSen::Quat& so) const
{
    Vec3d temp_trans;
    Vec3d temp_scale;
...
void KunSen::Matrixf::decompose(KunSen::Vec3d& t,
                             KunSen::Quat& r,
							 KunSen::Vec3d& s,
							 KunSen::Quat& so) const
{
...
void KunSen::Matrixd::decompose(KunSen::Vec3f& t,
                             KunSen::Quat& r,
							 KunSen::Vec3f& s,
							 KunSen::Quat& so) const
{
...
void KunSen::Matrixd::decompose(KunSen::Vec3d& t,
                             KunSen::Quat& r,
							 KunSen::Vec3d& s,
							 KunSen::Quat& so) const
{
