...
#ifndef KUNSEN_MATRIXF
#define KUNSEN_MATRIXF 1
...
class EXPORT_API Matrixf
{
    ...
    /*    inline bool valid() const { return !isNaN(); }
        ...
        void decompose( KunSen::Vec3f& translation,
                        KunSen::Quat& rotation,
						KunSen::Vec3f& scale,
						KunSen::Quat& so) const;

        /** decompose the matrix into translation, rotation, scale and scale orientation.*/
		void decompose(KunSen::Vec3d& translation,
                        KunSen::Quat& rotation,
						KunSen::Vec3d& scale,
						KunSen::Quat& so) const;
